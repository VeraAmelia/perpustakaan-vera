                        ...
                        <form action="{{ route('buku.update', $bukus->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('kode_buku') is-invalid @enderror"
                                    name="kode_buku" value="{{ old('kode_buku', $bukus->kode_buku) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('judul') is-invalid @enderror"
                                    name="judul"
                                    value="{{ old('judul', $anggotas->nama) }}" required>
                                ...
                                <select name="kategori_id" class="form-control @error('kategori_id') is-invalid @enderror"
                                    ...
                                    @foreach ($kategoris as $kategori)
                                        <option value="{{ $kategori->id }}"
                                            {{ $kategori->id == $bukus->kategori_id ? 'selected="selected"' : '' }}>
                                ...
                                <select name="penerbit_id" class="form-control @error('penerbit_id') is-invalid @enderror"
                                    ...
                                    @foreach ($penerbits as $penerbit)
                                        <option value="{{ $penerbit->id }}"
                                            {{ $penerbit->id == $bukus->penerbit_id ? 'selected="selected"' : '' }}>
                                            {{ $penerbit->kode_penerbit }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <input type="isbn" class="form-control @error('isbn') is-invalid @enderror"
                                    name="isbn" value="{{ old('isbn', $bukus->isbn) }}"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('pengarang') is-invalid @enderror"
                                    name="pengarang" value="{{ old('pengarang', $bukus->pengarang) }}" required>
                            ...
                            <div class="form-group">
                                <label for="jumlah_halaman">Jumah Halaman</label>
                                <input type="text" class="form-control @error('jumlah_halaman') is-invalid @enderror"
                                    name="jumlah_halaman" value="{{ old('jumlah_halaman', $bukus->jumlah_halaman) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('tahun_terbit') is-invalid @enderror"
                                    name="tahun_terbit" value="{{ old('tahun_terbit', $bukus->tahun_terbit) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('sinopsis') is-invalid @enderror"
                                    name="sinopsis" value="{{ old('sinopsis', $bukus->sinopsis) }}" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('gambar') is-invalid @enderror"
                                    name="gambar" value="{{ old('gambar', $bukus->gambar) }}" required>
